    ...
    return (  
        <>
            <div className='w-100 m-0 p-4 text-center bg-dark text-light' id='files'>
                ...
                <div className='w-100 px-2 d-flex flex-row justify-content-evenly align-items-baseline py-1'>
                    {data.map((file)=>
                ...
                <div className='w-100 px-2 d-flex flex-row justify-content-evenly align-items-baseline'>
                    {data.map((file)=>
                        <div className='d-flex flex-column justify-content-center align-items-center w-50'>
